// Shared care/profile operations; every page receives independent state.
module.exports = function createAccountPage(options = {}) {
...
return {
  ...
  onShow() {
    ...
    if (options.careOnly && target && CARE_TYPES[target]) this.openCareDetail({ currentTarget: { dataset: { key: target } } })
